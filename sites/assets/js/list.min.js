		...
		setup_kanban_boards() {
			...
			frappe.db.exists("Kanban Board", last_opened_kanban).then(function (exists) {
				if (exists) {
					...
					frappe.views.KanbanView.show_kanban_dialog(this$1.doctype, true);
				}
			});
		}
	...
	frappe.views.KanbanView.show_kanban_dialog = function (doctype, show_existing) {
		...
		function new_kanban_dialog(kanbans, show_existing) {
			...
			*/
			...
			var dialog_fields = get_fields_for_dialog(kanbans.map(function (kanban) { return kanban.name; }), show_existing);
